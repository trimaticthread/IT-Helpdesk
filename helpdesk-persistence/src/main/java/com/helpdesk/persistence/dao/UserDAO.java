 ...
 *
 * Kullanim zinciri:
 *   UserServiceImpl → UserDAO → UserDAOImpl (JdbcTemplate + MySQL)
 *
 * Onemli metotlar:
 * - assignRole  : Bir kullaniciya rol atar (user_roles join tablosu).
 * - getRoleName : Login sirasinda kullanicinin rolunu okur.
