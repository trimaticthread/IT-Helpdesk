 ...
 * Admin sadece sistem yonetimi yapar — ticket islemleri bu ekranda yer almaz.
 *
 * Sekmeler:
 * - Users       : Kullanici yonetimi (olusturma, duzenleme, sifre sifirlama).
 * - Categories  : Kategori CRUD.
 * - Departments : Departman CRUD.
 * - Groups      : Grup yonetimi (kullanici atama).
 * - SLA Settings: SLA kurallari.
 */
